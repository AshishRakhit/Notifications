...
def SendNotification(Applist, dt1, strlink):
    ...
    if MessageBody_settings['ToAddresses'] != None and Bus_settings['SharedAccessKeyValue'] != None and \
    Bus_settings['ServiceNamespace'] != None:
        Address_list = MessageBody_settings['ToAddresses'].split(",")
        ...
        message = {
            ...
            'FromAddress' : 'doNotReply@oxy.com',
            'ReplyTo' : '',
            'FromName' : 'Process Alert(s) ' + CipherConfig.Country + '-' + CipherConfig.Environment,
